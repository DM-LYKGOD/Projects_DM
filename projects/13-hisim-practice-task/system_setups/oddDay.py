...
from hisim.components import advanced_heat_pump_hplib_OddDay
...
class HouseholdHeatPumpConfig(SystemSetupConfigBase):
    ...
    hp_controller_config: advanced_heat_pump_hplib_OddDay.HeatPumpHplibControllerL1Config
    hp_config: advanced_heat_pump_hplib_OddDay.HeatPumpHplibConfig
    ...
    def get_scaled_default(
        ...
        household_config = HouseholdHeatPumpConfig(
            ...
            hp_controller_config=advanced_heat_pump_hplib_OddDay.HeatPumpHplibControllerL1Config.get_default_generic_heat_pump_controller_config(
                heat_distribution_system_type=my_hds_controller_information.heat_distribution_system_type,
                mode=options.heat_pump_controller_mode,
            ),
            hp_config=(
                advanced_heat_pump_hplib_OddDay.HeatPumpHplibConfig.get_scaled_advanced_hp_lib(
...
def setup_function(
    ...
    # Advanced Heat Pump Controller
    my_heat_pump_controller = advanced_heat_pump_hplib_OddDay.HeatPumpHplibController(
        config=my_config.hp_controller_config,
        my_simulation_parameters=my_simulation_parameters,
    )

    # Advanced Heat Pump
    my_heat_pump = advanced_heat_pump_hplib_OddDay.HeatPumpHplib(
